                    ...
                    <div class="col-sm-3" style="background: #f1f1f1">
                        <div class="bg p-2">
                            ...
                            <div class="form-group ">
                                ...
                                <select name="ncategory_id" id=""
                                    class="form-control {{ $errors->has('ncategory_id') ? 'is-invalid' : '' }}" required>
                                    <option value="">Select an option</option>
                                    @if (isset($categories))
                                        @foreach ($categories as $category)
                                            @php $dash=''; @endphp
                                            <option value="{{ $category->id }}"
                                                {{ old('ncategory_id') == $category->id ? 'selected' : '' }}>
                                ...
                                @if ($errors->has('ncategory_id'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('ncategory_id') }}
                                    </div>
                                @endif
                            </div>
                            <hr>
