<aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="info">
                <a href="#" class="d-block">Hi @if (Auth::check())
                        {{ Auth::user()->name }}
                    @endif
                </a>
            </div>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
              ...
              @endcan --}}
                ...
                @can('user-list')
                    <li
                        class="nav-item {{ strpos(Route::currentRouteName(), 'user') == 0 ? '' : 'menu-open' }} {{ strpos(Route::currentRouteName(), 'role') == 0 ? '' : 'menu-open' }}">
                        <a href="#"
                            class="nav-link {{ strpos(Route::currentRouteName(), 'user') == 0 ? '' : 'active' }}{{ strpos(Route::currentRouteName(), 'role') == 0 ? '' : 'active' }}">
                            <i class="nav-icon fas fa-users"></i>
                            <p>
                            ...
                            @can('user-list')
                                <li class="nav-item">
                                    <a href="{{ route('admin.users.index') }}"
                                        class="nav-link {{ strpos(Route::currentRouteName(), 'user') == 0 ? '' : 'active' }}">
                                        <i class="far fa-circle nav-icon"></i>
                            ...
                            @can('role-list')
                                <li class="nav-item">
                                    <a href="{{ route('admin.roles.index') }}"
                                        class="nav-link {{ strpos(Route::currentRouteName(), 'role') == 0 ? '' : 'active' }}">
                                        <i class="far fa-circle nav-icon"></i>
