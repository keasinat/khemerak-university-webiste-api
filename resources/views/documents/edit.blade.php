                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="title_km"
                                ...
                                value="{{ old('title_km') ?? $document->title_km }}">
                                ...
                                @if (isset($categories))
                                    @foreach ($categories as $category)
                                        ...
                                        <option value="{{ $category->id }}"
                                            {{ old('dcategory_id') ?? $document->dcategory_id == $category->id ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <select name="is_published" id="is_published" class="form-control">
                                @foreach (pulishedOpt() as $k => $item)
                                    <option value="{{ $k }}"
                                        {{ $document->is_published == $k ? 'selected' : '' }}>{{ $item }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="post_date" id="post_date"
                                ...
                                value="{{ isset($document->post_date) ? $document->post_date->format('d-m-Y') : $document->post_date }}"
                                autocomplete="off">
