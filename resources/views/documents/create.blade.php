                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="" class="form-label">Title in Khmer</label>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="" class="form-label">Title in English</label>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="input-group">
                            ...
                            <input id="file" class="form-control {{ $errors->has('file') ? 'is-invalid' : '' }}"
                                type="text" name="file" value="{{ old('file') }}">
                            @if ($errors->has('file'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('file') }}
                                </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group ">
                            ...
                            <select name="dcategory_id" id=""
                                class="form-control {{ $errors->has('dcategory_id') ? 'is-invalid' : '' }}">
                                @if (isset($categories))
                                    @foreach ($categories as $category)
                                        @php $dash=''; @endphp
                                        <option value="{{ $category->id }}"
                                            {{ old('dcategory_id') == $category->id ? 'selected' : '' }}>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="input-group">
                            ...
                            <input id="thumbnail" class="form-control {{ $errors->has('thumbnail') ? 'is-invalid' : '' }}"
                                type="text" name="thumbnail" value="{{ old('thumbnail') }}">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="post_date" id="post_date"
                                ...
                                value="{{ old('post_date') }}" autocomplete="off">
