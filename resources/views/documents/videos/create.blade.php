...
@section('content')
    <x-forms.post :action="route('admin.document.video.store')">
        <x-card>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control {{ $errors->has('file') ? 'is-invalid' : '' }}" type="text" name="file" placeholder="https://www.youtube.com/watch?v=xxxxxxxxx" value="{{ old('file') }}">
                                    @if($errors->has('file'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('file') }}
                                        </div>
