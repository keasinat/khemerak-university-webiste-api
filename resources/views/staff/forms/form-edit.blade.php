    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            ...
            <div class="form-group">
                ...
                <input type="text" name="short_desc_en" id="" class="form-control {{ $errors->has('short_desc_en') ? 'is-invalid' : '' }}" value="{{ old('short_desc_en') ?? $staff->short_desc_en }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="short_desc_km" id="" class="form-control {{ $errors->has('short_desc_km') ? 'is-invalid' : '' }}" value="{{ old('short_desc_km') ?? $staff->short_desc_km }}">
